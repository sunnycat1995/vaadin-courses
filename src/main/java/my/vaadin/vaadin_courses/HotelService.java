...
public class HotelService {
	...
	public synchronized List<Hotel> findAll(String hotelNameFilter, String addressFilter) {
		ArrayList<Hotel> arrayList = new ArrayList<>();
		for (Hotel hotel : hotels.values()) {
			try {
				boolean passesFilter = ((hotelNameFilter == null || hotelNameFilter.isEmpty())
						|| hotel.getName().toString().toLowerCase().contains(hotelNameFilter.toLowerCase())) &&
	...
	public synchronized List<Hotel> findAll(String hotelNameFilter, String addressFilter, int start, int maxresults) {
		ArrayList<Hotel> arrayList = new ArrayList<>();
		for (Hotel contact : hotels.values()) {
			try {
				boolean passesFilter = (hotelNameFilter == null || hotelNameFilter.isEmpty())
						|| contact.toString().toLowerCase().contains(hotelNameFilter.toLowerCase());
				if (passesFilter) {
